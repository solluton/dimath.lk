...
try {
    $pdo = getDBConnection();
    $stmt = $pdo->prepare("SELECT * FROM legal_pages WHERE page_type = 'terms-of-service'");
    $stmt->execute();
...
if (!$privacy) {
    $privacy = [
        ...
        'content' => '<p>These default terms will be replaced once configured in the admin panel.</p>'
    ];
}
?>
