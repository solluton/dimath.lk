...
$page_content = getLegalPageContent('cookies-policy');
...
<head>
  ...
  <meta content="Learn about how Dimath Group uses cookies on our website. Our cookie policy explains what cookies we use, why we use them, and how you can manage your cookie preferences." property="twitter:description">
