...
try {
    $pdo = getDBConnection();
    $stmt = $pdo->prepare("SELECT * FROM legal_pages WHERE page_type = 'cookies-policy'");
    $stmt->execute();
...
if (!$privacy) {
    $privacy = [
        ...
        'content' => '<p>This cookies policy will be replaced once configured in the admin panel.</p>'
    ];
}
?>
...
<head>
  <meta charset="utf-8">
  <title><?php echo htmlspecialchars($privacy['title']); ?></title>
  <meta content="<?php echo htmlspecialchars(strip_tags($privacy['title'])); ?>" property="og:title">
  <meta content="<?php echo htmlspecialchars(strip_tags($privacy['title'])); ?>" property="twitter:title">
            ...
            <div class="padding-section-large">
              <div class="cta51_component">
                <div class="w-richtext">
                  <h1 class="margin-bottom margin-medium"><?php echo htmlspecialchars($privacy['title']); ?></h1>
