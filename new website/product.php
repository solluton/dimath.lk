      ...
      <div class="navbar1_container">
        ...
        <nav role="navigation" class="navbar1_menu is-page-height-tablet w-nav-menu">
          <div class="navbar1_menu-links">
            ...
            <a href="product.html" aria-current="page" class="navbar1_link w-nav-link w--current">Products</a>
                ...
                <div class="w-layout-grid product-header5_layout">
                  <div data-w-id="6f4165df-ce2b-d605-986b-f4628c5d78f5" style="opacity:0" class="product-header5_gallery">
                    <a href="#" class="product-header5_lightbox-link w-inline-block w-lightbox">
                      <div class="product-header5_main-image-wrapper"><img loading="lazy" src="https://uploads-ssl.webflow.com/624380709031623bfe4aee60/6243807090316203124aee66_placeholder-image.svg" alt="" class="product-header5_main-image"></div>
                    ...
                    <div class="product-header5_list-wrapper hide-tablet">
                      <div class="product-header5_list">
                        <div class="product-header5_item">
                          <a href="#" class="product-header5_lightbox-link w-inline-block w-lightbox">
                            <div class="product-header5_image-wrapper"><img loading="lazy" src="https://uploads-ssl.webflow.com/624380709031623bfe4aee60/6243807090316203124aee66_placeholder-image.svg" alt="" class="product-header5_image"></div>
                            <script type="application/json" class="w-json">{
  "items": [],
  "group": ""
}</script>
                  ...
                  <div data-w-id="6f4165df-ce2b-d605-986b-f4628c5d7913" style="opacity:0" class="product-header5_product-details">
                    ...
                    <div class="margin-bottom margin-small">
                      <div class="product-header5_heading-wrapper">
                        <h1 class="heading-style-h3">Cricket Bat</h1>
                        <div class="heading-style-h4">$55</div>
                      </div>
                    </div>
                    <div class="margin-bottom margin-small">
                      <div class="product-header5_reviews-wrapper">
                        <div class="product-header5_rating-wrapper">
                          <div class="product-header5_rating-icon">
                        ...
                        <div class="text-size-small">(3.5 stars) • 10 reviews</div>
                      </div>
                    </div>
                    <div class="margin-bottom margin-small">
                      <p>This cricket bat combines durability with performance, making it perfect for players of all levels. Experience the power and precision with every swing.</p>
                    </div>
                    <div class="margin-bottom margin-small">
                      <div class="product-cta-buttons-wrapper">
                        <a href="#" class="button w-button">Contact Us</a>
                        <a href="#" class="button is-secondary is-alternate w-button">Call Us</a>
                      </div>
                    </div>
                    <div class="product-header5_accordion-wrapper">
                      <div class="product-header5_accordion">
                        ...
                        <div class="product-header5_details">
                          <div class="margin-bottom margin-small">
                            <p>This cricket bat is crafted from premium wood, ensuring a lightweight yet sturdy feel. It features a comfortable grip for enhanced control during play. Perfect for both practice sessions and competitive matches.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="margin-bottom margin-xxlarge">
                  <div class="product5_heading-wrapper">
                    ...
                    <div class="button-group is-right hide-mobile-landscape">
                      <a data-w-id="6f4165df-ce2b-d605-986b-f4628c5d798c" style="opacity:0" href="#" class="button is-secondary is-alternate w-button">View All</a>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="product5_slide w-slide">
                      <div class="product5_item">
                        <a href="#" class="product5_item-link w-inline-block">
                          <div class="margin-bottom margin-xsmall">
                            <div class="product5_image-wrapper"><img sizes="100vw" srcset="images/default-14_1default-14.avif 500w, images/default-14_1default-14.avif 800w, images/default-14_1default-14.avif 1080w, images/default-14_1.avif 2000w" alt="" src="images/default-14_1.avif" loading="eager" class="product5_image"></div>
                          </div>
